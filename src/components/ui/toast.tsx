...
export interface ToasterRef {
  show: (props: ToasterProps) => string | number | undefined;
  dismiss: (toastId: string | number | undefined) => void;
  update: (toastId: string | number | undefined, props: ToasterProps) => void;
}
      ...
      update: (toastId, props) => {
        ...
        sonnerToast.custom(
            (t) => (
              ...
              { id: toastId, duration: props.duration, position: props.position }
        )
      }
    }));
